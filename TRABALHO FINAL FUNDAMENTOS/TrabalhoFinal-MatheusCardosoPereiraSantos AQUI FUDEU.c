...
void gerarRelatorio(FILE *arquivo, char *nomeObra, char *dataInicio, char *dataTermino, int diasPassados, int diasRestantes, float pctPassado, char *responsavel, float orcamentoTotal, float gastoAtual, float orcamentoRestante, float pctGasto, char *mestredeObras, float salarioTotal, float pctOrcGastoFuncionarios, float gastoTotal, int faseObra) {
    ...
    fprintf(arquivo, "Gasto total: %.2f\n", gastoTotal);
...
float orcamentoTotal, gastoMaodeObra, pctGasto, salarioFuncionarios, gastoAtual, pctOrcGastoFuncionarios, pctPassado, gastosAdicionais, gastoTotal=gastoMaodeObra+gastosAdicionais+salarioFuncionarios;
...
gerarRelatorio(arquivo, nomeObra, dataInicio, dataTermino, diasPassados, diasRestantes, pctPassado, responsavel, orcamentoTotal, gastoAtual, orcamentoRestante, gastoTotal, pctGasto, mestredeObras, salarioTotal, pctOrcGastoFuncionarios, gastoTotal, faseObra);
